            ...
            <div class="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div class="footer-links">
                    ...
                    <ul class="text-gray-400 space-y-2">
                        <li><a href="/invest-plan" class="hover:text-yellow-500">Investment Plans</a></li>
                ...
                <div class="footer-contact">
                    ...
                    <a href="/contact-us" id="contact-us" class="mt-2 text-gray-400 block">
                        <span id="contact-us">Contact Us</span>
                    </a>
                    <a href="#" id="supportEmailLink" class="mt-2 text-gray-400 block supportemail">
                        <strong>Email:</strong> <span id="supportEmailText" class="supportemailtext">loading…</span>
                    </a>
...
<script>
  document.addEventListener("DOMContentLoaded", () => {
    const hostPort = window.location.host.replace(/^www\./, '');
    const email = `info@${hostPort}`;
    const mailto = `mailto:${email}`;

    const links = document.querySelectorAll('.supportemail');
    const texts = document.querySelectorAll('.supportemailtext');

    links.forEach(link => link.setAttribute('href', mailto));
    texts.forEach(text => text.textContent = email);
  });
</script>
